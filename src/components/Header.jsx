                      ...
                      <div>
                        <Menu.Button className="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                          ...
                          <Image
                            ...
                            height={100}
                            src={userData?.imageUrl || 'https://th.bing.com/th/id/R.98f7ba11c0008416714360d79b38fcc3?rik=QlFH8ZvFQS9J3w&pid=ImgRaw&r=0'}
                            width={100}
                          />
                        </Menu.Button>
                      </div>
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                <div className="flex items-center px-5">
                  <div className="flex-shrink-0">
                    <Image alt="Avatar" className="h-10 w-10 rounded-full" src={userData?.imageUrl || 'https://picsum.photos/640/640?r=2471'} />
                  </div>
                  <div className="ml-3">
                ...
                <div className="mt-3 px-2 space-y-1">
                  {userNavigation.map(item => (
                    <Disclosure.Button key={item.name} as="a" className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700" href={item.href}>
                      {item.name}
                    </Disclosure.Button>
                  ))}
                </div>
